...
~Done~
  ...
  * SG1: Implement a start button. The digital timer should not start until the button is pressed. ~Done~
  ...
  * SG4: Finally, if you have completed all the stretch goals, spend some time styling your timer and buttons. ~Done~